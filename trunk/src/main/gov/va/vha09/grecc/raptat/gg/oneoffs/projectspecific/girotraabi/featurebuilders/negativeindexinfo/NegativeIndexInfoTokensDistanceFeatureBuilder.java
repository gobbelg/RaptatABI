...
public class NegativeIndexInfoTokensDistanceFeatureBuilder extends NegativeIndexInfoFeatureBuilder {
  /**
   * Instantiates a new laterality tokens distance feature builder.
   */
  public NegativeIndexInfoTokensDistanceFeatureBuilder() {
