...
import src.main.gov.va.vha09.grecc.raptat.gg.uima.makers.UIMAAnnotatedPhraseMaker;
...
public class UIMAPhraseFinder extends JCasAnnotator_ImplBase {
  private static final UIMAAnnotatedPhraseMaker phraseMaker = new UIMAAnnotatedPhraseMaker();
