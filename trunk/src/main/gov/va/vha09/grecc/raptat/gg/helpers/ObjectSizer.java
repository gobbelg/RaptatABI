...
/**
 * Measures the approximate size of an object in memory, given a Class which has a no-argument
 * constructor.
 */
public final class ObjectSizer {
  ...
  public static long getObjectSize(Class aClass) {
    ...
    Object[] objects = new Object[ObjectSizer.fSAMPLE_SIZE];
  ...
  /**
   * First and only argument is the package-qualified name of a class which has a no-argument
   * constructor.
   */
  ...
  private static void collectGarbage() {
    try {
      ...
      Thread.sleep(ObjectSizer.fSLEEP_INTERVAL);
